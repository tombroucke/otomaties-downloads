...
class Loader
{
     ...
     *
     * @var array<int|string, mixed> $actions The actions registered with WordPress to fire when the plugin loads.
     */
    protected $actions;
     ...
     *
     * @var array<int|string, mixed> $filters The filters registered with WordPress to fire when the plugin loads.
     */
    protected $filters;
